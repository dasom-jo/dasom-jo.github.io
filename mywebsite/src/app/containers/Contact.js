...
const Contact = () => {
    ...
    return (
        ...
        <div className={styles.contactBox}>
            {/* 프레임 줄 */}
            <div
            className={styles.contactFrameLine}
            ref={clickFrameLineRef}
            ></div>
            {/* 프레임 */}
            <div
                ref={clickFrameRef}
            ...
            >
                {/* 프레임 내부 연락처 텍스트 */}
                <div
                    className={styles.contactAddr}
                    ref={clickTextRef}
                >
                    <p>
                        깃 허브 : <a href="https://github.com/dasom-jo" target="_blank">https://github.com/dasom-jo</a>
                    </p>
                    <p>
                        노션 : <a href="https://transparent-drop-0f2.notion.site/I-m-a-front-end-developer-10c28716df6680f9b8b4d682d02d8f67"
                        target="_blank">
                    ...
                    <p>
                        메일 : <a href="mailto:jodasom0216@gmail.com">jodasom0216@gmail.com</a>
                    </p>
                    <p>
                        블로그 : <a href="https://github.com/dasom-jo">jodasom0216@gmail.com</a>
                    </p>
                </div>
